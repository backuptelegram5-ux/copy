...
function refreshCookieViaPhone($currentCookie, $uA) {
    ...
    $ch = curl_init();
    curl_setopt_array($ch, [
        CURLOPT_URL            => 'https://www.yellorush.co.za/?e-msisdn=' . urlencode($eMsisdn),
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_HEADER         => true,
...
$cookie = 'XSRF-TOKEN=%3D;yello_rush_session=%3D';
if (empty($cookie)) die("\nNo cookie (?c=...)\n");
